...
def longest_path(graph):
	...
	# as the first node has no parent an as such is not updated by the algorithm. The 
...
my_graph=[[int(x),0] for x in triangle_to_list("/home/shane/Code/python/puzzle/project_euler/prob_18_input")]
